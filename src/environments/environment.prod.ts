export const environment = {
  SITE_URL: 'https://flyealo.com',
  SITE_NAME: 'Flyealo',
  SITE_LANG: 'en-ES',
  SITE_DESCRIPTION: 'Flyealo creates personalized AI travel itineraries for European trips. Plan cities, days, and interests in minutes.',
  SUPABASE_URL: 'https://irdgmryukluierxiemck.supabase.co',
  SUPABASE_KEY: 'sb_publishable_9F0wavV4PduUOE5HNJWPzw_cBypTkFD',
  GROQ_KEY: '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',
